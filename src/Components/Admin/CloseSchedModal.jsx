...
function Close({setIsModalVisible, closeSched }) {
    return(
        <>
            ...
            <div className={`modal fade show`} style={{ display: 'block' }} aria-labelledby="staticBackdropLabel" aria-hidden="true">
              <div className="modal-dialog">
                <div className="modal-content">
                  ...
                  האם אתה בטוח שברצונך לסגור את הסידור ? לאחר הסגירה לא ניתן לשחזר את הסידור
                  </div>
                  <div className="modal-footer">
                      <button type="button" onClick={closeSched} className="btn btn-primary">סגור סידור</button>
